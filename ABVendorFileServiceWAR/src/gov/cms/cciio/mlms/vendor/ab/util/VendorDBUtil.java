package gov.cms.cciio.mlms.vendor.ab.util;
...
public class VendorDBUtil {
	...
	private static Logger logger = Logger.getLogger("VendorDBUtil.class");
	...
	public static void freeDBResources(ResultSet rs, Statement statement, Connection conn, String source) throws SQLException {
		try {
			...
			logger.log(Level.SEVERE,"SQLException: Datasource resources closing error!" + e.getMessage());
			e.printStackTrace();
			throw e;
		}
	}
