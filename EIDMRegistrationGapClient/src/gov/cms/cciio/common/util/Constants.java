 ...
 * 2015-02-10	Steve Meyer	    Added values for MLMS
 * 2016-11-15	Steve Meyer     Updated
 */
...
//    public static final String USER_DEFAULT_ATRRS_STATUS = "Information Unavailable";
  ...
  /* Security List */
   ...
   // public static final String ORDER_ACCP_ADD_REASON     = "ACCP Automatic Completion Notice";
    ...
    public static String AB_ROLE_EFFECTIVE_DATE = "AgentBrokerRoleEffectiveDate";
    ...
    public static String SHOP_TRAINING = "SHOPTraining";
